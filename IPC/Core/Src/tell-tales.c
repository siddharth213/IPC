...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, seatBelt_LED_Pin|handBrake_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : seatBelt_LED_Pin handBrake_LED_Pin */
  GPIO_InitStruct.Pin = seatBelt_LED_Pin|handBrake_LED_Pin;
